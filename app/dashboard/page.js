                ...
                <div className="container mx-auto px-2 sm:px-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 mb-4 sm:mb-6 lg:mb-8">
                        ...
                        <div className="bg-white p-4 sm:p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100 transform hover:-translate-y-1">
                            ...
                            <div className="mt-3 sm:mt-4 space-y-2">
                                <Link
                                    href="/order-history"
                                    className="inline-flex items-center text-green-600 text-xs sm:text-sm font-medium hover:text-green-700 group"
                                >
                                    My purchases
                                    <ChevronRight size={14} className="ml-1 transition-transform group-hover:translate-x-1" />
                                </Link>
                                ...
                                <Link
                                    href="/seller-orders"
                                    className="inline-flex items-center text-blue-600 text-xs sm:text-sm font-medium hover:text-blue-700 group"
                                >
                    ...
                    <div className="bg-white rounded-xl shadow-md p-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            ...
                            <Link
                                href="/seller-orders"
                                className="w-full text-left px-4 py-3 bg-orange-50 text-orange-700 hover:bg-orange-100 rounded-xl transition-colors flex items-center group border border-orange-100"
                            >
                                <div className="p-2 bg-white rounded-lg mr-3 text-orange-600">
                    ...
                    {/* Analytics Section */}
                    <div className="mt-8">
                        <DashboardAnalytics stats={dashboardData.stats} />
                    </div>
                </div>
            </main>
        </div>
