...
export default function AIRecommendPage() {
  ...
  const handleSearch = async () => {
    if (!query.trim()) {
      setMessage('Please enter item names you\'re looking for');
      return;
    }
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Tell us what items you're looking for, and our AI will find the best sellers for you
            </p>
          </div>
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1">
                ...
                <input
                  ...
                  placeholder="e.g., saree, mobile phone, laptop, books, furniture, jewelry..."
                ...
                <p className="text-xs text-gray-500 mt-2">
                  💡 <strong>Tip:</strong> Search for second-hand items available on our platform. Try: Kanjivaram saree, iPhone, MacBook, dining table, gold earrings, textbooks, etc.
                </p>
              </div>
              <div className="flex items-end">
                ...
                >
                  ...
                  {loading ? 'Searching...' : 'Find Best Sellers'}
                </button>
              </div>
            </div>
          </div>
          ...
          {recommendations.length > 0 && (
            <div className="space-y-6">
              {recommendations.map((rec, index) => {
                ...
                const seller = material.createdBy;
                            ...
                            {rec.alternatives.slice(0, 2).map((alt, altIndex) => (
                              <div key={altIndex} className="flex items-center justify-between bg-gray-50 p-3 rounded-lg">
                                <div>
                                  ...
                                  <p className="text-xs text-gray-500">{alt.createdBy?.name}</p>
