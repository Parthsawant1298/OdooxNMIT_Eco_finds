...
export default function PricingSection() {
  ...
  const plans = [
    {
      name: "Basic Explorer",
      description: "For casual shoppers discovering sustainable finds",
      price: {
        monthly: 99,
        yearly: 990,
      },
      features: [
        "Browse unlimited items",
    ...
    {
      name: "Eco Enthusiast",
      description: "For active buyers and sellers in the marketplace",
      price: {
        monthly: 299,
        yearly: 2990,
      },
    ...
    },
    {
      ...
      description: "For power users and eco-conscious businesses",
      price: {
        monthly: 699,
        yearly: 6990,
      },
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
            Choose the perfect plan for your sustainable shopping needs
          </p>
        </motion.div>
