...
const StatsComponent = () => {
  ...
  useEffect(() => {
    ...
    const timer = setInterval(() => {
      ...
      setCounts({
        sellers: Math.floor(progress * targetValues.sellers),
        buyers: Math.floor(progress * targetValues.buyers),
  ...
  const stats = [
    ...
    },
    {
      ...
      value: counts.buyers.toLocaleString(),
      label: "Active Buyers",
      suffix: "+",
    },
    {
  ...
  return (
    <div className="w-full py-16" style={{background: 'linear-gradient(to bottom, #ffffff 0%, #f0f9f0 100%)'}}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          Trusted by <span style={{color: '#347433'}}>Eco-Conscious Shoppers Everywhere</span>
        </motion.h2>
