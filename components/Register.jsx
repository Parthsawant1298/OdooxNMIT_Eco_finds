...
import { Store, Shield, UserPlus } from 'lucide-react';
                        ...
                        <div className="grid md:grid-cols-5 gap-8">
                            ...
                            <div className="md:col-span-2 bg-white p-6 rounded-xl shadow-lg border border-gray-200 hidden md:block">
                                <div className="mb-6">
                                    ...
                                    <p className="text-gray-600">
                                        Create your account to access AI-powered supply chain solutions with:
                                    </p>
                                </div>
                                ...
                                <div className="space-y-6">
                                    <FeatureCard 
                                        ...
                                        description="Quick and simple account creation to get you started in minutes."
                                    />
                                    <FeatureCard 
                                    ...
                                    <FeatureCard 
                                        ...
                                        description="Access a vast network of suppliers and find the best deals for your business needs."
                                    />
                                </div>
                            ...
                            <div className="md:col-span-3 bg-white p-6 sm:p-8 rounded-xl shadow-lg border border-gray-200">
                                <div className="text-center mb-6">
                                    ...
                                    <p className="text-gray-600">Join thousands of users already using SupplyMind</p>
                                </div>
