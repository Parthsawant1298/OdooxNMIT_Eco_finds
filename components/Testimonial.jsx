  ...
  const testimonials = [
    {
      ...
      quote: "EcoFinds has completely changed how I shop! I've found amazing pre-owned furniture and electronics at great prices while helping the environment.",
      rating: 5,
      company: "Green Living Enthusiast, Mumbai"
    },
    {
      name: "Alex Rodriguez",
      role: "Vintage Collector",
      image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=150&h=150&q=80",
      quote: "The quality verification process gives me confidence in every purchase. I've discovered unique vintage items that you can't find anywhere else.",
      rating: 5,
      company: "Vintage Collector, Delhi"
    },
    {
      name: "Emma Thompson",
      role: "Student",
      image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&w=150&h=150&q=80",
      quote: "As a student on a budget, EcoFinds is perfect! I've furnished my entire dorm room with beautiful pre-owned items at affordable prices.",
      rating: 5,
      company: "College Student, Pune"
    },
    {
      name: "Rahul Kapoor",
      role: "Seller",
      image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=150&h=150&q=80",
      quote: "Selling on EcoFinds is so easy! The platform helped me declutter my home and make extra income while knowing my items found new loving homes.",
      rating: 5,
      company: "Happy Seller, Bangalore"
    },
    {
      name: "Lisa Park",
      role: "Environmental Advocate",
      image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=150&h=150&q=80",
      quote: "EcoFinds perfectly aligns with my values of sustainable living. Every purchase feels good knowing I'm reducing waste and supporting the circular economy.",
      rating: 5,
      company: "Sustainability Advocate, Chennai"
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="text-center mb-8 md:mb-16">
            <h2 className="text-2xl md:text-4xl font-bold text-gray-900 mb-4">
              Customer <span style={{ color: '#347433' }}>Stories</span>
            </h2>
            <p className="text-base md:text-lg text-gray-600 max-w-2xl mx-auto">
              Real experiences from eco-conscious shoppers who've discovered amazing finds on EcoFinds marketplace
            </p>
          </div>
