...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
        ...
        <div className="container mx-auto px-4 relative z-20 h-full">
          <div className="flex flex-col items-center justify-center h-full space-y-4 md:space-y-6">
            ...
            <p className="text-lg md:text-xl text-gray-700 text-center max-w-3xl">
              Get in touch with EcoFinds to join our sustainable marketplace community
            </p>
          </div>
        </div>
      </section>
      ...
      {/* Contact Section */}
      <main className="flex-grow" style={{ background: 'linear-gradient(180deg, white 0%, white 50%, white 100%)' }}>
        <div className="container mx-auto px-4 md:px-8 py-8 md:py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16">
            {/* Contact Information */}
            <div className="space-y-8 md:space-y-12">
              <div>
                <h3 className="mb-2 md:mb-3 text-base md:text-lg" style={{color: '#347433'}}>Sustainable Second-Hand Marketplace</h3>
                <h2 className="text-3xl md:text-4xl font-bold mb-4 md:mb-6 text-gray-900">
                  Connect with 
                  <span className="text-transparent bg-clip-text" style={{ background: 'linear-gradient(135deg, #347433 0%, #2d5f2d 100%)', WebkitBackgroundClip: 'text' }}> EcoFinds</span>
                </h2>
                <p className="text-gray-600 text-base md:text-lg leading-relaxed">
                  Founded in 2024, EcoFinds is a vibrant and trusted platform revolutionizing the way people buy and sell pre-owned goods. We're fostering a culture of sustainability by extending the lifecycle of products, reducing waste, and providing an accessible alternative to purchasing new items for our growing community of conscious consumers.
                </p>
              </div>
              ...
              <div className="space-y-6 md:space-y-10">
                {[
                  { 
                    ...
                    content: 'Every item undergoes careful inspection and verification for authenticity and condition, ensuring you get well-maintained pre-owned products.',
                    icon: <Clock style={{color: '#347433'}} size={24} />
                  },
                  { 
                    title: 'Secure Transactions',
                    content: 'Advanced security measures protect every transaction with buyer protection programs and verified seller credentials for complete peace of mind.',
                    icon: <Shield style={{color: '#347433'}} size={24} />
                  },
                  { 
                    title: 'Sustainable Shopping',
                    content: 'Electronics, furniture, clothing, books, household items - discover unique pre-owned treasures while supporting the circular economy.',
              ...
              <div className="space-y-4 pt-4 border-t border-gray-200">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <p className="text-gray-700">support@ecofinds.ai</p>
                </div>
                <div className="flex items-center space-x-3">
            ...
            <div className="bg-white p-6 md:p-8 rounded-lg shadow-xl mt-4 md:mt-7" style={{ border: '1px solid rgba(52, 116, 51, 0.2)' }}>
              <h3 className="text-2xl font-bold text-gray-900 mb-6">Get Started with EcoFinds</h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  placeholder="Tell us about your sustainable shopping needs or items you'd like to sell"
                  rows="4"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                description: "Advanced privacy system protects user data while ensuring complete seller transparency and quality verification",
                icon: "�"
              },
              {
        ...
        <div className="h-[300px] md:h-[400px] w-full mt-8 md:mt-16">
          <iframe
            ...
            title="EcoFinds Office Location"
          ></iframe>
        </div>
      </main>
