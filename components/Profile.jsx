...
const ProfilePage = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      // Trigger a custom event to notify header to refresh user data
      // This ensures the header shows the new profile picture
                ...
                <div className="flex-grow">
                  <div className="space-y-4">
                    ...
                    {user?.businessAddress && user.businessAddress.trim() && (
                      <div>
                        ...
                        <p className="text-lg font-medium text-gray-900">{user.businessAddress}</p>
                      </div>
                    )}
                  ...
                  <div className="mt-8 space-y-3">
                    <button 
                      ...
                      className="px-6 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors mr-4"
                    >
                      Edit Profile
                    </button>
                    ...
                    <div className="pt-4 border-t border-gray-200">
                      <p className="text-sm text-gray-600">
                        ...
                        <a href="mailto:support@ecofinds.com" className="text-green-600 hover:underline">
