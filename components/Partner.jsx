        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-8 sm:mb-12 md:mb-16 lg:mb-20">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl font-bold mb-4 md:mb-6 text-gray-900 leading-tight">
              Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-green-700">Trusted</span> Community
            </h2>
            <p className="text-sm sm:text-base md:text-lg text-gray-600 mx-auto max-w-2xl lg:max-w-3xl leading-relaxed px-4">
              We connect conscious buyers and sellers in a trusted marketplace, ensuring quality pre-owned items and fair pricing for everyone
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-20 items-center">
            ...
            <div className="bg-white p-4 sm:p-6 md:p-8 rounded-xl md:rounded-2xl shadow-lg md:shadow-xl border border-gray-100 min-h-[500px] sm:min-h-[600px] lg:h-[700px] flex flex-col hover:shadow-xl md:hover:shadow-2xl transition-all duration-500 order-2 lg:order-1">
              <div className="text-center mb-6 md:mb-8">
                <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 mb-3 md:mb-4">Our Marketplace Categories</h3>
                <p className="text-gray-600 text-xs sm:text-sm leading-relaxed px-2">
                  At EcoFinds, we carefully verify all items and sellers to ensure buyers get quality pre-owned products at fair prices
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 gap-3 sm:gap-4 flex-1 py-2">
                <div className="flex items-center gap-3 sm:gap-4 bg-gradient-to-r from-gray-50 to-green-50/50 p-3 sm:p-4 rounded-lg md:rounded-xl hover:from-green-50 hover:to-green-100 transition-all duration-300 group shadow-sm hover:shadow-md">
                  ...
                  <div className="flex-1 min-w-0">
                    <h4 className="font-bold text-green-700 text-xs sm:text-sm mb-1 truncate">Electronics & Gadgets</h4>
                    <p className="text-gray-600 text-xs leading-relaxed">Quality pre-owned smartphones, laptops, tablets, and electronics delivered with warranty</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 sm:gap-4 bg-gradient-to-r from-gray-50 to-green-50/50 p-3 sm:p-4 rounded-lg md:rounded-xl hover:from-green-50 hover:to-green-100 transition-all duration-300 group shadow-sm hover:shadow-md">
                  ...
                  <div className="flex-1 min-w-0">
                    <h4 className="font-bold text-green-700 text-xs sm:text-sm mb-1 truncate">Furniture & Home Decor</h4>
                    <p className="text-gray-600 text-xs leading-relaxed">Beautiful pre-owned furniture, home decor, and vintage pieces from verified sellers</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 sm:gap-4 bg-gradient-to-r from-gray-50 to-green-50/50 p-3 sm:p-4 rounded-lg md:rounded-xl hover:from-green-50 hover:to-green-100 transition-all duration-300 group shadow-sm hover:shadow-md">
                  ...
                  <div className="flex-1 min-w-0">
                    <h4 className="font-bold text-green-700 text-xs sm:text-sm mb-1 truncate">Fashion & Clothing</h4>
                    <p className="text-gray-600 text-xs leading-relaxed">Stylish pre-loved clothing, accessories, and fashion items in excellent condition</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 sm:gap-4 bg-gradient-to-r from-gray-50 to-green-50/50 p-3 sm:p-4 rounded-lg md:rounded-xl hover:from-green-50 hover:to-green-100 transition-all duration-300 group shadow-sm hover:shadow-md">
                  ...
                  <div className="flex-1 min-w-0">
                    <h4 className="font-bold text-green-700 text-xs sm:text-sm mb-1 truncate">Books & Media</h4>
                    <p className="text-gray-600 text-xs leading-relaxed">Extensive collection of books, DVDs, games, and educational materials</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 sm:gap-4 bg-gradient-to-r from-gray-50 to-green-50/50 p-3 sm:p-4 rounded-lg md:rounded-xl hover:from-green-50 hover:to-green-100 transition-all duration-300 group shadow-sm hover:shadow-md">
                  ...
                  <div className="flex-1 min-w-0">
                    <h4 className="font-bold text-green-700 text-xs sm:text-sm mb-1 truncate">Household Items</h4>
                    <p className="text-gray-600 text-xs leading-relaxed">Kitchen appliances, tools, home essentials, and household items in great condition</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative flex items-center justify-center min-h-[400px] sm:min-h-[500px] md:min-h-[600px] lg:min-h-[700px] order-1 lg:order-2">
              <div className="relative w-[280px] h-[280px] sm:w-[350px] sm:h-[350px] md:w-[400px] md:h-[400px] lg:w-[450px] lg:h-[450px]">
                ...
                {/* Bottom Right Image - Marketplace Items - LARGEST */}
